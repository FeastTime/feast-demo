...
public class MD5Utils {
    ...
    //秘钥
    private final static String myKeyString = "afTPD11UZKjLKxkL1LcdC+uOad2saGxT7xqZvVW6QX0FNvS5FCz1u0QFuqmG5VPQFZ0C2wVgXfAX\n" +
            "0BHk4YiQ0g==";
    /**
     * 全局数组
     */
    ...
    public static String encryptHMAC(String data) {
        ...
        byte[] bytes = encryptHMAC(data.getBytes(), myKeyString);
